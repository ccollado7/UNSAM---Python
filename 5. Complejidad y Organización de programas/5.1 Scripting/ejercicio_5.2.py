...
#Defino la Funcion N°5
def informe_camion(nombre_archivo_camion,nombre_archivo_precios):
    '''Funcion que recibe los nombres de 2 archivos (contenido del camion y precios)
       una tabla con formato'''
...
#Unico llamado del programa a la funcion que devuelve la tabla con formato
